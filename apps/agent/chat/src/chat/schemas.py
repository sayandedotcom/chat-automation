...
class IntegrationInfo(BaseModel):
    ...
    name: str = Field(
        ..., description="Integration identifier (e.g., 'web_search', 'gmail')"
    )
    display_name: str = Field(
        ..., description="Human-readable name (e.g., 'Web Search', 'Gmail')"
    )
...
class Artifact(BaseModel):
    ...
    metadata: dict = Field(
        default_factory=dict, description="Extra context (recipients, content preview)"
    )
