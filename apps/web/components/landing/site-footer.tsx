...
export function SiteFooter() {
  return (
    <footer className="relative pt-32 pb-12 bg-black text-neutral-400 text-sm overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-t from-[#533ccf]/10 to-transparent pointer-events-none" />

      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-16">
          <div className="col-span-2">
            <Link href="/" className="flex items-center gap-2 font-bold text-xl mb-4">
              <div className="w-8 h-8 bg-[#533ccf] rounded-lg flex items-center justify-center">
